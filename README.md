...
#9) Create tables (run from one node only):  
  iex(n1@127.0.0.1)6> Database1.create!(disk: nodes)  
  :ok  

--wait for all nodes to complete  
  iex(n1@127.0.0.1)7> :ok = Database1.wait(15000)   
  :ok  
...
#12) Read the data  
  ...
  iex(n1@127.0.0.1)10>Amnesia.transaction do  
...
#13) Delete data:  
  ...
  ...(n1@127.0.0.1)11> bill = %User{name: "Bill", email: "bill@blahblah.com"} |> User.write  
  ...(n1@127.0.0.1)11> end  

  iex(n1@127.0.0.1)12>Amnesia.transaction do  
  ...
  iex(n1@127.0.0.1)14>Amnesia.transaction do  
  ...(n1@127.0.0.1)14> r = User.where id > 0  
  ...(n1@127.0.0.1)14> r |> Amnesia.Selection.values  
  ...(n1@127.0.0.1)14> |> Enum.each &IO.inspect(&1)  
  ...(n1@127.0.0.1)14> end  
...
Some mnesia info that might come in handy:  
  ...
  or using a list comprehension:  
    list1 = for t <- :mnesia.system_info(:tables), do: {t, :mnesia.table_info(t, :where_to_commit)}  
